...
function main() {
    ...
    const table = "dist/.resources/blender/table.obj";
    ...
    const marble = textureLoader.load("dist/.resources/textures/Red_Marble_002_COLOR.jpg");

    scene.background = new THREE.CubeTextureLoader()
        .setPath("dist/.resources/textures/field-skyboxes/Meadow/")
    ...
    function onClick(event) {
        ...
        if (intersects.length != 0 && intersects[0].object.name === "clickbox" && !gameWon) {
            ...
            audioLoader.load("dist/.resources/sound/piece_drop.wav", function (buffer) {
    ...
    function win(winningPiece) {
        ...
        if (winningPiece == "xpiece") {
            ...
            audioLoader.load("dist/.resources/sound/x_win.wav", function (buffer) {
                sound.setBuffer(buffer);
                sound.setLoop(false);
                sound.isPlaying = false;
                sound.setVolume(0.3);
        ...
        // If O wins the game
            ...
            // Play the win vocal audio
            audioLoader.load("dist/.resources/sound/o_win.wav", function (buffer) {
                sound.setBuffer(buffer);
                sound.setLoop(false);
                sound.isPlaying = false;
                sound.setVolume(0.3);
